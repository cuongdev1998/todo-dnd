...
export const SVGIcon = ({ name, color, width, height }) => {
    ...
    switch (name) {
        case 'clear':
            return (
                <svg id="Capa_1" enableBackground="new 0 0 413.348 413.348" height={`${height ? height : '16'}`} viewBox="0 0 413.348 413.348" width={`${width ? width : '16'}`} xmlns="http://www.w3.org/2000/svg"><path d="m413.348 24.354-24.354-24.354-182.32 182.32-182.32-182.32-24.354 24.354 182.32 182.32-182.32 182.32 24.354 24.354 182.32-182.32 182.32 182.32 24.354-24.354-182.32-182.32z" /></svg>
            )
        case 'pending':
            return (
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 512 512" enableBackground="new 0 0 512 512" xmlSpace="preserve" width={`${width ? width : '16'}`} height={`${height ? height : '16'}`} 
        ...
        case 'done':
            return (
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    width={`${width ? width : '16'}`} height={`${height ? height : '16'}`} viewBox="0 0 405.272 405.272" enableBackground ="new 0 0 405.272 405.272"
                    xmlSpace="preserve" fill={`${color ? color : '#000000'}`}>
                    <g>
        ...
        case 'inprogress':
            return(
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width={`${width ? width : '16'}`} height={`${height ? height : '16'}`} viewBox="0 0 399.389 399.389" enableBackground = "new 0 0 399.389 399.389"
                    xmlSpace="preserve" fill={`${color ? color : '#000000'}`}>
                <g>
                    <path d="M340.896,58.49C303.18,20.773,253.031,0.001,199.693,0.001c-53.34,0-103.487,20.771-141.204,58.489
                        ...
                        C248.184,18.155,293.771,37.038,328.061,71.327z"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
                </svg>
            )
        default:
            return null;
